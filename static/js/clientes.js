document.addEventListener("DOMContentLoaded", function () {
    ...
    window.mostrarFormulario = function (tipo) {
        ...
        if (tipo === 'nuevo') {
            form.reset();
            document.getElementById("titulo-formulario").textContent = "Insertar un nuevo cliente";
            document.getElementById("cliente_id").value = "";
        } else if (tipo === 'modificar') {
            const seleccionado = document.querySelector("#tabla-clientes tr.seleccionado");
            if (!seleccionado) {
                mostrarMensaje();
                return;
            }
            document.getElementById("titulo-formulario").textContent = "Modificar cliente";
            ...
            document.getElementById("cliente_id").value = seleccionado.dataset.id;
        }
    };
...
$(document).ready(function () {
    ...
    $('#tabla-clientes tbody').on('click', 'tr', function () {
        if ($(this).hasClass('seleccionado')) {
            ...
            $('#tabla-clientes tbody tr').removeClass('seleccionado');
